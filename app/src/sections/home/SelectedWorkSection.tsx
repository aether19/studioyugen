    ...
    <section className="py-24 lg:py-40 bg-background border-t border-foreground/[0.08]">
      <Container>
        ...
        <ScrollReveal className="mb-3">
          <Link to={`/work/${projects[0].slug}`} className="group relative block">
        ...
        {/* Beaver Trap — full width at bottom */}
        <ScrollReveal>
          <Link to={`/work/${projects[6].slug}`} className="group relative block">
            <div className="aspect-[16/8] overflow-hidden bg-gray-100">
              <img
